...
def gen_test_data(
    ...
    assert receiver_item_cnt > 0 and sender_item_cnt > 0 and intersection_cnt > 0
    assert receiver_item_cnt >= intersection_cnt and sender_item_cnt >= intersection_cnt

    receiver_minus_intersection_cnt = receiver_item_cnt - intersection_cnt
    total_cnt = receiver_item_cnt + sender_item_cnt - intersection_cnt
    ...
    assert r == receiver_item_cnt and s == sender_item_cnt and i == intersection_cnt
