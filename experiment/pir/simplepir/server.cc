...
void PIRServer::server_setup(std::shared_ptr<yacl::link::Context> lctx) {
...
void PIRServer::server_query(std::shared_ptr<yacl::link::Context> lctx) {
...
void PIRServer::server_answer(std::shared_ptr<yacl::link::Context> lctx) {
  const size_t row_num = static_cast<size_t>(sqrt(N_));
