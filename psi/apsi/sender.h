...
class LabelPsiSender {
 public:
  explicit LabelPsiSender(std::shared_ptr<ISenderDB> sender_db);
   ...
   * @param link_ctx
   */
  static void RunOPRF(const std::shared_ptr<ecdh::IEcdhOprfServer>& oprf_server,
 ...
 private:
  std::shared_ptr<ISenderDB> sender_db_;
