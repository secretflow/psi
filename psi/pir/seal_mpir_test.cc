...
TEST_P(SealMultiPirTest, Works) {
  ...
  double factor = 1.5;
  size_t hash_num = 3;
  ::psi::psi::CuckooIndex::Options cuckoo_params{batch_number, 0, hash_num,
                                                 factor};
  ...
  ::psi::pir::MultiQueryOptions options{
  ...
  ::psi::pir::MultiQueryServer mpir_server(options, cuckoo_params, seed_server);

  ::psi::pir::MultiQueryClient mpir_client(options, cuckoo_params, seed_client);
