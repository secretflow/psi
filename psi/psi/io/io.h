...
struct FileIoOptions {
  FileIoOptions() = default;
  explicit FileIoOptions(const std::string& f, bool trunc_in = true,
                         bool exit_for_fail_in_destructor_in = true)
      : file_name(f),
        trunc(trunc_in),
        exit_for_fail_in_destructor(exit_for_fail_in_destructor_in) {}
  ...
  bool exit_for_fail_in_destructor = true;
};
